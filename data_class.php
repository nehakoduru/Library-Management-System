...
class data extends db {
    ...
    function addbook($bookname, $bookdetail, $bookauthor, $bookpub, $bookprice, $bookquantity) {
       ...
       $q="INSERT INTO book(id,bookname, bookdetail, bookauthor, bookpub, bookprice,bookquantity,bookava,bookrent)VALUES('', '$bookname', '$bookdetail', '$bookauthor', '$bookpub', '$bookprice', '$bookquantity','$bookquantity',0)";
